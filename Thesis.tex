...
\mainmatter
   ...
   \part{Supersymmetric gauge theories }
     ...
     \input{Chapters/SYM.tex}
     \input{Chapters/WilsonLoops.tex}
   \part{Gauge/string duality}
     \input{Chapters/supergravity.tex}
     \input{Chapters/AdSCFT.tex}
%      \input{Chapters/Dbranes.tex}
     \input{Chapters/HoloWL.tex}
     
   \input{Chapters/Conclusion}  
   \input{Chapters/SummarySwedish}  
